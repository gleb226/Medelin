        ...
        <div class="bean-full-view">
            <div class="bean-full-view__container" style="display: grid; grid-template-columns: 1.1fr 1fr; gap: 4rem; align-items: stretch; margin-bottom: 3rem;">
                ...
                <div class="bean-full-view__right-col" style="display: flex; flex-direction: column;">
                    ...
                    <div class="bean-full-view__primary-stats" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; background: var(--color-coffee-soft); padding: 2.5rem; border-radius: 24px; border: 1px solid rgba(255, 255, 255, 0.1); flex-grow: 1; align-content: start; color: #fff; box-shadow: var(--shadow-md);">
