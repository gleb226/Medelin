    ...
    detailContent.innerHTML = `
        <div class="bean-full-view">
            ...
            <div class="bean-full-view__main" style="display: flex; flex-wrap: wrap; gap: 3rem; align-items: stretch; margin-bottom: 3rem;">
                <div class="bean-full-view__image-side" style="flex: 1; min-width: 300px; display: flex; flex-direction: column; gap: 2rem;">
                    <img src="${item.image_url || defImg}" alt="${displayName}" style="width: 100%; border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.12); object-fit: cover; flex-grow: 1; max-height: 500px;">
                ...
                <div class="bean-full-view__info-side" style="flex: 1.2; min-width: 300px; display: flex; flex-direction: column;">
                    ...
                    <div class="bean-full-view__primary-stats" style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; background: white; padding: 2.5rem; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.04); border: 1px solid rgba(139, 94, 60, 0.05); flex-grow: 1;">
                        ...
                        ${score ? `<div><label style="display: block; font-weight: 800; font-size: 0.75rem; text-transform: uppercase; color: var(--color-coffee); margin-bottom: 0.5rem; opacity: 0.7;">Оцінка якості</label><p style="font-size: 1.1rem; font-weight: 700;">${score}</p></div>` : ''}
                        ...
                        ${item.processing ? `<div style="grid-column: span 2;"><label style="display: block; font-weight: 800; font-size: 0.75rem; text-transform: uppercase; color: var(--color-coffee); margin-bottom: 0.5rem; opacity: 0.7;">Метод обробки</label><p style="font-size: 1.1rem; font-weight: 700;">${item.processing}</p></div>` : ''}
                    </div>
